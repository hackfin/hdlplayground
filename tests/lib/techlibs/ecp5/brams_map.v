module \$__ECP5_DP16KD (CLK2, CLK3,
	...
	localparam WRITEMODE_B = TRANSP3 ? "WRITETHROUGH" : "READBEFOREWRITE";
	...
	generate if (CFG_DBITS == 1) begin
		DP16KD #(
			...
			.CLKA(CLK2), .CLKB(CLK3),
			.WEA(A1WE), .CEA(A1CE), .OCEA(1'b1),
			.WEB(B1WE), .CEB(B1CE), .OCEB(1'b1),
...
module \$__ECP5_PDPW16KD (CLK2, CLK3, A1ADDR, A1WRITE, A1EN, B1ADDR, B1READ, B1EN);
